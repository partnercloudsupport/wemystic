...
class AstrologyChinese extends StatefulWidget {
  @override
  AstrologyChineseState createState() => AstrologyChineseState();
}

class AstrologyChineseState extends State<AstrologyChinese> {
  var list;
  var random;
